...
module.exports = function (environmentOptions, buildOptions, vendorFiles, amdModules) {
  ...
  if (fs.existsSync(environmentOptions['modulesDir'] + '/@webcomponentsjs/webcomponentsjs')) {
    vendorScripts.webcomponents = funnel(new source.UnwatchedDir(environmentOptions['modulesDir'] + '/@webcomponentsjs/webcomponentsjs'), {
      files: ['webcomponents-bundle.js']
    });
  }
