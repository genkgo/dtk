...
module.exports = function (environmentOptions, buildOptions, vendorFiles, amdModules) {
  ...
  let loader = funnel(new source.UnwatchedDir(environmentOptions['modulesDir'] + '/loader.js/dist/loader'), {
    files: ['loader.js']
  });
  ...
  let concatJs = concat(mergeTrees([
    ...
    footer: "require(['" + environmentOptions['name'] + "/index'])['default'](" + JSON.stringify(exposedVariables) + ");}());",
  });
