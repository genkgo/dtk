...
module.exports = function (environmentOptions, buildOptions, vendorFiles, amdModules) {
  ...
  let modernizrPath = {};
  quickTemp.makeOrReuse(modernizrPath, 'dir');
  ...
  modernizr.build(buildOptions['modernizr'], (result) => {
    fs.writeFileSync(modernizrPath.dir + '/modernizr.js', result, {encoding: 'utf8'});
  });

  let modernizrFile = funnel(new source.UnwatchedDir(modernizrPath.dir), {
    'files': ['modernizr.js']
  });
